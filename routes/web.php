...
Route::get('/formulaire/user-information', [App\Http\Controllers\FormulaireController::class, 'formulaire_user']);
Route::get('/formulaire/info', [App\Http\Controllers\FormulaireController::class, 'check_info']);
